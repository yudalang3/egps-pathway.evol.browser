 ...
 * @date 2024-04-27
 */
public class PipelineWebToAlignmentView implements RunningTask {
	// Final variables
	// ##########################################################
	 ...
	 *
	 */
	public PipelineWebToAlignmentView(HashMap<String, String> t, String geneSymbol) {
	 ...
	 */
	public PipelineWebToAlignmentView(HashMap<String, String> t, String region, boolean hasGenomicRegion) {
