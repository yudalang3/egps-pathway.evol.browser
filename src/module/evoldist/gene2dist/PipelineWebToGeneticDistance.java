 ...
 * 
 */
public class PipelineWebToGeneticDistance extends PipelineWebToAlignmentView {

	public PipelineWebToGeneticDistance(HashMap<String, String> t, String geneSymbol) {
		super(t, geneSymbol);
	}

	public PipelineWebToGeneticDistance(HashMap<String, String> t, String region, boolean hasGenomicRegion) {
	...
	private void calculate_evolutionary_distance() throws Exception {
		...
		DistanceParameterConfigurer.configureDistanceCalculator(distanceCalculateor, settingValues);
