...
public class Entity {
    ...
    @JSONField(name = "backpageHead")
    public String getBackpageHead() {
        return backpageHead;
    }

    public void setBackpageHead(String backpageHead) {
        this.backpageHead = backpageHead;
    }
    ...
    @JSONField(name = "kaavioType")
    public String getKaavioType() {
        return kaavioType;
    }

    public void setKaavioType(String kaavioType) {
        this.kaavioType = kaavioType;
    }
