 ...
 * @date 2024-04-27
 */
public class PipelineWebToAlignment implements RunningTask {
	// Final variables
	// ##########################################################
	 ...
	 * 
	 */
	public PipelineWebToAlignment(Map<String, String> t, String geneSymbol) {
	 ...
	 */
	public PipelineWebToAlignment(Map<String, String> t, String region, boolean hasGenomicRegion) {
