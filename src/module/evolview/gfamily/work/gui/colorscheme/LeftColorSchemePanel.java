...
public class LeftColorSchemePanel extends JPanel implements ItemListener {
	...
	public LeftColorSchemePanel(GeneFamilyController controller) {
...
//				DialogFrame dialog = DialogFrame.obetainCountryDialog(controller,controller.getGloablCountry2numberMap());
...
//			DialogFrame dialog = DialogFrame.obetainGenderDialog(controller);
//			dialog.setVisible(true);
		});
		...
		buttonAgeAdj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
//				DialogFrame dialog = DialogFrame.obetainAgeDialog(controller);
//				dialog.setVisible(true);
			}
		});
		...
		buttonDateAdj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
//				DialogFrame dialog = DialogFrame.obetainDateDialog(controller);
//				dialog.setVisible(true);
			}
		});
		...
		btnAddCustomedScheme.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Runnable callBack = () -> {
					letCustomizedRadioButtonBeSelected();
				};
				DialogFrame dialog = DialogFrame.obetainCustomizedTreeDialog(controller, callBack);
				dialog.setVisible(true);
