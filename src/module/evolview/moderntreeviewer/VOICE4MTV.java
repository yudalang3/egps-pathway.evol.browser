 ...
 */
public class VOICE4MTV extends AbstractGuiBaseVoiceFeaturedPanel {

    private static final Logger log = LoggerFactory.getLogger(VOICE4MTV.class);
    ...
    public VOICE4MTV(MTreeViewMainFace mTreeViewMainFace) {
